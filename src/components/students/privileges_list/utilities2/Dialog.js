...
export default function Register(props) {
  ...
  React.useEffect(() => {
    if (!initialize) {
      ...
      setTenth([
        props.data.tenth_percentage,
        props.data.tenth_board,
        props.data.tenth_passed_year,
      ]);
      setTwelth([
        props.data.twelth_percentage,
        props.data.twelth_board,
        props.data.twelth_passed_year,
      ]);
      setDiplomo([
        props.data.diplomo_percentage,
        props.data.diplomo_board,
        props.data.diplomo_passed_year,
      ]);
