...
const terms = () => {
  return (
    <div style={termsAndConditionsStyle}>
      ...
      <br />
      <p>
        The Training & Placement Cell, The National Institute of Engineering,
        Mysore facilitates the process of placement of students passing out from
        the Institute besides collaborating with leading organizations and
        institutes in setting up of internship and training program of students.
        The office liaises with various industrial establishments, corporate
        houses etc which conduct campus interviews and select graduate and
        post-graduate students from all disciplines. The Training & Placement
        Cell provides the infra-structural facilities to conduct group
        discussions, tests and interviews besides catering to other logistics.
        The Office interacts with many industries in the country, of which
        nearly 100+ companies visit the campus for holding campus interviews.
        The industries which approach the institute come under the purview
        of:Core Engineering industries IT & IT enabled services, ,Manufacturing
        Industries Consultancy Firms, Finance Companies, Management
        Organisations, R & D laboratories. The placement season runs through the
        course of the year commencing the last week of July through to June.
        Pre-Placement Talks are also conducted in this regard as per mutual
        convenience. Job offers, dates of interviews, selection of candidates
        etc. are announced through the Training & Placement Cell. The Placement
        Office is assisted by a committee comprising representatives of students
        from the under-graduate and post-graduate engineering streams. The
        committee evolves a broad policy framework every year besides a set of
        rules which are inviolable. Students members are closely co-opted in
      ...
      <div>
        ...
        <p>
          ...
          shall manage your use of our website, Webiste, accessible at
          https://www.nieplacemets.com.
        </p>
        <p>
        ...
        <p>
          ...
          indeed our whole website, at our discretion and without notice.
        </p>
        <p>
          ...
          ensure that the user ID and password are kept confidential at all
          times.
        </p>
        <p>
          We reserve the right to disable your user ID and password at any time,
        ...
        <p>
          ...
          relating to user content, we do not undertake to monitor the
        ...
        <p>
          We provide our website on an “as is” basis and without any warranties
          of any kind, whether express or implied, including, but not limited
          to, implied warranties of merchantability, fitness for a particular
          purpose and non-infringement.
        </p>
        <p>
          We do not warrant that our website, or any content on it, will always
          be available or be uninterrupted. We will not be liable to you if for
        ...
        <p>
          ...
          website, or our entire website, to users who have registered with us.
        </p>
        <p>
          If you choose, or you are provided with, a user ID and password to
          enable you to access restricted areas of our website or other content
          or services, you must treat such information as confidential, and you
        ...
        <p>
          ...
          modification to, suspension of or discontinuance of our website.
        </p>
        <h2
          style={{
            fontSize: "32px",
        ...
        <p>
          Subject to any terms and conditions relating to products or services
          which you may have purchased through our website, these terms and
          conditions constitute the entire agreement between you and us and
          supersede all previous agreements between you and us in respect of
        ...
        <p>
          ...
          and construed in accordance with the laws of the State of Karnataka,
          India.
        </p>
      </div>
    </div>
